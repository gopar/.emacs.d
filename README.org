...
(use-package org-rainbow-tags
  ...
  :hook ((org-mode . org-rainbow-tags-mode)
         (org-agenda-mode . gopar/ort-workaround))
  ;; Enable once I catch all indented properties
  ;; :custom
  ;; (org-rainbow-tags--org-tag-regexp ":\\([[:alnum:]_@#%]+\\):")
  :init
  (defun gopar/ort-workaround ()
    (run-with-timer 1 nil 'org-rainbow-tags-mode)))
#+end_src
*** Org Private
My private stuff
...
(use-package code-compass
  :ensure nil
  :defer t
  :load-path "/Users/daniel.gopar/work/code-compass")
#+end_src
...
(use-package sticky-shell
  :ensure t
  :defer t
  :straight (:host github :repo "andyjda/sticky-shell")
