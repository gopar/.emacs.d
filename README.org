...
(use-package midnight
  ...
  (clean-buffer-list-delay-special 10) ; last ten minutes
...
(use-package mwheel :ensure nil
  :init
  (defun scroll-left-one () (interactive) (scroll-left 2))
  (defun scroll-right-one () (interactive) (scroll-right 2))

  (global-set-key (kbd "<wheel-right>") 'scroll-left-one)
  (global-set-key (kbd "<wheel-left>") 'scroll-right-one)
  )
#+end_src
...
(use-package chatgpt-shell
  ...
  (chatgpt-shell-model-versions '( "gpt-4" "gpt-4-32k" "gpt-3.5-turbo-16k" "gpt-3.5-turbo")))
#+end_src
*** Dall-E
