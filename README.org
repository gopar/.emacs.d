...
#+begin_src emacs-lisp
(defun gopar/mu-back-to-last-edit ()
...
(global-set-key (kbd "M-/") 'gopar/mu-back-to-last-edit)
#+end_src
...
(use-package soft-stone-theme
  ...
  :defer t)
#+end_src
**** [[https://github.com/WJCFerguson/emacs-faff-theme/][Faff Theme]]
#+begin_src emacs-lisp
...
(use-package rand-theme
  ...
  :ensure t
  :init
  (setq rand-theme-light '(minimal-light tao-yang soft-stone eziam-light faff autumn-light))
...
** COMMENT [[https://github.com/aviaviavi/link-preview.el][Link Preview]]
Its not in melpa yet
#+begin_src emacs-lisp
