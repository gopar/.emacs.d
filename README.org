...
(use-package grep
  ...
  :defer
  :config
  (setq grep-find-ignored-directories (append grep-find-ignored-directories '(".mypy_cache" ".pytest_cache" "htmlcov"))))
#+end_src
...
(use-package consult
  :ensure
  :after projectile
  :commands (gopar/consult-line consult-buffer)
...
(use-package doom-themes
  :ensure t
  :hook (emacs-startup . (lambda () (load-theme 'doom-gruvbox)))
  :config
