#+STARTUP: showall
#+TITLE: Emacs Configuration [⚠️ No Longer Maintained]
#+PROPERTY: header-args :tangle README.el

I moved my config to a private repo with my other dotfiles.
I wont be touching this repo, but i'll leave it up as some might
get some ideas/tips from it.
...
*** [[https://github.com/vale981/py-vterm-interaction.el][py-vterm-interaction]]
