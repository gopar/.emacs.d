...
*** [[https://github.com/emacsomancer/org-roam-daily-reflection/tree/main][Org Roam Dailies]]
...
(use-package org-roam-daily-reflection
  ...
  :custom
  (org-roam-daily-reflection-dailies-directory "~/.emacs.d/org/private/journal/daily/"))
#+end_src
*** Org Annotate File
#+begin_src emacs-lisp
...
(use-package eshell
  ...
  :hook ((eshell-directory-change . gopar/sync-dir-in-buffer-name)
         ...
         (eshell-mode . (lambda ()
                          ...
                          (setq-local corfu-count 3)
                          (setq-local completion-at-point-functions '(pcomplete-completions-at-point cape-file cape-history)))))
  :custom
...
*** COMMENT [[https://github.com/scop/emacs-ruff-format][Ruff]]
#+begin_src emacs-lisp
...
*** COMMENT [[https://github.com/anachronic/importmagic.el][importmagic]]
#+begin_src emacs-lisp
(use-package importmagic
  ...
  :hook ((python-mode python-ts-mode) . gopar/enable-importmagic-if-found)
  :init
...
*** COMMENT [[https://github.com/muffinmad/emacs-pdb-capf][Gud pdb]]
...
(use-package pdb-capf
  :ensure t
  :defer
  :quelpa (pdb-capf :fetcher github :repo "muffinmad/emacs-pdb-capf")
  :init
...
#+END_SRC
*** [[https://github.com/topikettunen/tok-theme][Tok]]
#+begin_src emacs-lisp
...
(use-package auto-dark
  ...
  (setq auto-dark-light-theme 'tao-yang) ;; tok
  )
#+end_src
