...
(use-package newsticker
  :ensure nil
  :defer t
  :bind ("C-c C-x g" . newsticker-show-news)
  :custom
  ;; (newsticker-obsolete-item-max-age (* 60 60 24 7)) ; Lets keep entries around for a week at least
  (newsticker-automatically-mark-items-as-old nil)
  (newsticker-treeview-automatically-mark-displayed-items-as-old nil)
  (newsticker-treeview-listwindow-height 15)
  :init
  (setq newsticker-url-list-defaults '(("Howardism" "https://www.howardism.org/index.xml" nil nil)
                                    ("r/Emacs" "https://www.reddit.com/r/emacs/.rss" nil nil)
                                    ("irreal" "https://irreal.org/blog/?tag=emacs&feed=rss2" nil nil)
                                    ("xenodium" "https://xenodium.com/rss.xml" nil nil)
                                    ("Pragmatic Emacs" "https://pragmaticemacs.wordpress.com/feed/" nil nil)
                                    ("Emacs Ninja" "https://emacsninja.com/emacs.atom" nil nil)
                                    ("Mastering Emacs" "https://www.masteringemacs.org/feed" nil nil)
                                    ("Emacs Horrors" "https://emacshorrors.com/feed.atom" nil nil)
                                    ("Sachas Blog" "https://sachachua.com/blog/category/emacs/feed/index.xml" nil nil)
                                    ("Prog Blog" "https://protesilaos.com/codelog.xml" nil nil)
                                    ("Adam Johnson" "https://adamj.eu/tech/atom.xml" nil nil)
                                    ("Caktus Group" "https://www.caktusgroup.com/feeds/main/" nil nil))))
#+end_src
** Solar
#+begin_src emacs-lisp
(use-package solar
