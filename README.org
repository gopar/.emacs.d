...
(defun gopar/save-window-config-and-show-work-agenda ()
  ...
  (find-file-other-window "~/.emacs.d/org/private/break_checklist.org"))
...
(use-package org-roam
  ...
  :ensure t
  :init
  (setq org-roam-directory (expand-file-name "./org/private/org-roam/"))
  (setq org-roam-db-location (expand-file-name "./org/private/org-roam/"))
  :custom
  (org-roam-directory (expand-file-name "./org/private/org-roam/"))
  (org-roam-db-location (expand-file-name "./org/private/org-roam/"))
