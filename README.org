...
=pip install jedi epc importmagic ruff mypy coverage pytest-cov pytest pyright=
...
** [[https://github.com/casouri/eldoc-box][Eldoc]]
...
** AI Stuff
*** COMMENT [[https://github.com/xenodium/chatgpt-shell][ChatGPT]]
#+begin_src emacs-lisp
...
(use-package aidermacs
  ...
  (aidermacs-program "/Users/gopar/projs/cecli/.venv/bin/cecli")
  ...
  (aidermacs-project-read-only-files '("CONVENTIONS.md"))
  (aidermacs-extra-args `(
                        ...
                        "--no-detect-urls"
                        "--linear-output"
                        ,(concat "--mcp-servers-file " (expand-file-name "~/") ".config/mcp/mcp.json")))
  (aidermacs-architect-model "claude-opus-4-5")
  ;; (aidermacs-architect-model "openai/gpt-5")
  (aidermacs-editor-model "claude-3-7-sonnet-latest")
  (aidermacs-weak-model "claude-3-5-haiku-latest")
  (aidermacs-default-model "claude-opus-4-5"))
#+end_src
...
** [[https://github.com/11111000000/tao-theme-emacs][Tao Themes]]
#+begin_src emacs-lisp
...
(use-package god-mode
  ...
  :hook ((after-init . god-mode-all)
         ;;(god-local-mode . read-only-mode)
         )
  :init
  (setq god-mode-enable-function-key-translation nil)

  (defun gopar/god-mode-enable-insert ()
    (interactive)
    (god-local-mode -1)
    (read-only-mode -1))
  ...
  (define-key god-local-mode-map (kbd "i") #'gopar/god-mode-enable-insert)
...
#+end_src
** [[https://github.com/purcell/envrc][envrc (direnv)]]
#+begin_src emacs-lisp
(use-package envrc
  :ensure t
  :defer
