...
(defun gopar/add-env-vars ()
  ...
  ;; Should probably copy all the paths from PATH onto here
...
** COMMENT [[https://github.com/seagle0128/doom-modeline/][Doom Modeline]]
...
** COMMENT [[https://github.com/skeeto/impatient-mode][Impatient mode]]
...
if you want markdown preview then do these extra steps:
...
(use-package importmagic
    :ensure t
    :diminish
    :bind (("C-c C-l" . gopar/importmagic-fix))
    :hook (python-mode . importmagic-mode)
    :config
    (defun gopar/importmagic-fix (&optional arg)
      "Fix import at point, with prefix fix all imports"
      (if arg
