...
(defun gopar/add-env-vars ()
  ...
  (setenv "PATH" (concat (getenv "PATH") (concat ":" (expand-file-name "~/.nvm/versions/node/v14.16.0/bin"))))
  ...
  (setenv "NVM_PATH" (expand-file-name "~/.nvm/versions/node/v14.16.0/bin/node/"))
  (setenv "NVM_BIN" (expand-file-name "~/.nvm/versions/node/v14.16.0/bin/"))
